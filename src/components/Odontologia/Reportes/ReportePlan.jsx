// components/Odontologia/Reportes/ReportePlan.jsx
import React from 'react';
import { FiPrinter, FiEye, FiBookOpen, FiX, FiUser } from 'react-icons/fi';

export default function ReportePlan({ 
  pacientes, 
  onSelectPaciente, 
  selectedPaciente, 
  onPrint,
    ...
    <div className="odonto-reporte-content">
      <div className="odonto-reporte-actions">
        <button className="odonto-btn-primary" onClick={onPrint}>
          <FiPrinter size={16} /> Imprimir Plan
        </button>
      ...
      <div className="odontograma-reporte-container">
        <div className="odontograma-placeholder">
          <FiBookOpen size={64} style={{ color: 'var(--text-muted)' }} />
          <p style={{ color: 'var(--text-muted)', marginTop: 12 }}>
            El plan de tratamiento mostrará todos los procedimientos programados para el paciente.
          </p>
          <p style={{ fontSize: 13, color: 'var(--text-dim)' }}>
            Incluye: nombre del plan, descripción, costo total y estado.
          </p>
        </div>
      </div>
    </div>
