...
export const HALLAZGOS_CON_SUPERFICIE = [
  ...
  'fractura',
  'provisional',
  // ✅ AHORA TAMBIÉN INCLUYE FAVORABLES QUE PUEDEN TENER SUPERFICIE
  'resina_adaptada',
  'amalgama_adaptada',
  'sellante_bueno',
  'corona_buena',
...
export const HALLAZGOS_GLOBALES = [
  ...
  'provisional',
  'otro',
  // ✅ AHORA TAMBIÉN INCLUYE FAVORABLES COMO GLOBALES
  'diente_sano',
  'resina_adaptada',
  'amalgama_adaptada',
  'sellante_bueno',
...
// ============================================================
// ✅ OBTENER HALLAZGOS NO FAVORABLES (para múltiples dientes)
// ============================================================
...
// ✅ Obtener hallazgos NO favorables de un solo diente
export const obtenerHallazgosNoFavorablesDelDiente = (tooth) => {
  if (!tooth) return [];
  ...
  // 1️⃣ Hallazgos por superficie
  Object.entries(caras).forEach(([surface, hallazgo]) => {
    if (hallazgo && esCondicionNoFavorable(hallazgo) && esHallazgoSuperficial(hallazgo)) {
      resultados.push({
        surface,
        hallazgo,
